...
<%
	...
	if(userEmail.isEmpty() == true){
		...
		script.println("alert('기입된 내용이 없습니다.');");
		script.println("history.back();");
		script.println("</script>");
		script.close();
		return;
	}
	System.out.println("Email send userID is "+userEmail);
	

	String host = "http://localhost:8080/Lecture_Evaluation/";
	String from = "tmdwns11011@gmail.com";
	String to = userEmail;
	String subject = "아이디 찾기 이메일 입니다.";  //이메일 제목
	String content = "다음 링크에 접속하여  아이디를 확인 하세요" + 
		"<a href='" + host + "UserIDEmailCheckAtion.jsp?code=" + new SHA256().getSHA256(to) + "'>이메일 인증하기</a>";
